        ...
        <div class="card-body">
            <div class="tab nav-center">
                <ul class="nav nav-tabs" id="myTab" role="tablist">
                    <li class="nav-item">
<a class="nav-link active show" id="estado-tab" data-toggle="tab" href="#estado" role="tab" aria-controls="estado"
    aria-selected="true"> Estado</a>
</li>
<li class="nav-item">
<a class="nav-link" id="dados-tab" data-toggle="tab" href="#dados" role="tab" aria-controls="dados"
...
<li class="nav-item">
<a class="nav-link" id="result-tab" data-toggle="tab" href="#result" role="tab" aria-controls="result"
    aria-selected="false"> Comprovativo
</a>
</li>
</ul>
...
<div id="collapse" class="collapse show" data-parent="#accordionsimplefill">
    <div class="card-body">
        <p>
O estado <span class="text-dark">pendente</span> significa que o seu pedido está sendo analizado pela nossa
equipa
...
<div id="collapse" class="collapse show" data-parent="#accordionsimplefill">
    <div class="card-body">
        <p>
O estado <span class="text-dark">confirmado</span> significa que o seu pedido já foi analizado pela nossa
equipa
...
<input type="text" class="form-control" id="endereco" placeholder="Província, Município, Bairro, Rua, Número da casa..."
    required>
</div>
...
<div id="collapse" class="collapse show" data-parent="#accordionsimplefill">
    <div class="card-body">
        <p>
O estado <span class="text-dark">cancelado</span> significa que o seu pedido já foi analizado pela nossa
equipa
...
<li class="list-group-item text-dark">País de origem do produto: <strong>{{ $redirecionamento->paisOrigem
        }}</strong></strong> </li>
<li class="list-group-item text-dark">País de destino do produto: <strong>{{ $redirecionamento->paisDestino }}</strong>
</li>
...
const response = await fetch('https://sonlinedigital.com/api/updateEnderecoEntrega/',
{
method:'POST',
headers: {
