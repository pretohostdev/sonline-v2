                        ...
                        <div class="row d-flex justify-content-center">
                            <div class="col-md-8 text-center">
                                <div class="error-text">
                                    ...
                                    <p class="text-dark" style="font-size: 14pt; font-family:sans-serif">Você não tem permissão para acessar essa página, ela é usada apenas para pessoas autorizadas.</p>
